...
import dummyMaid from '../data/dummyMaid';
import '../styles/Home.css';
import maidimg from '../images/maid.jpg'
const Maid = () => {
      ...
      <Container className="py-4">
        ...
        {loading ? (
          ...
          <Row xs={1} md={2} lg={3} className="g-4">
            {workers.map(worker => (
              <Col key={worker.id}>
                <WorkerCard worker={worker} image={maidimg} rateUnit={"per month"} />
              </Col>
            ))}
          </Row>
        )}
